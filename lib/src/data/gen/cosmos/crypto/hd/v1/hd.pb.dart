...
class BIP44Params extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'BIP44Params', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'cosmos.crypto.hd.v1'), createEmptyInstance: create)
    ...
    ..aOB(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'change')
    ..a<$core.int>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'addressIndex', $pb.PbFieldType.OU3)
  ...
  factory BIP44Params.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory BIP44Params.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  ...
  'Will be removed in next major version')
  BIP44Params copyWith(void Function(BIP44Params) updates) => super.copyWith((message) => updates(message as BIP44Params)) as BIP44Params; // ignore: deprecated_member_use
  ...
  @$core.pragma('dart2js:noInline')
  static BIP44Params getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<BIP44Params>(create);
  ...
  @$pb.TagNumber(4)
  set change($core.bool v) { $_setBool(3, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  set addressIndex($core.int v) { $_setUnsignedInt32(4, v); }
  @$pb.TagNumber(5)
