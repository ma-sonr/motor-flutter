...
class SnapshotItem extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SnapshotItem', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'cosmos.base.snapshots.v1beta1'), createEmptyInstance: create)
    ...
    ..aOM<SnapshotKVItem>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'kv', subBuilder: SnapshotKVItem.create)
    ..aOM<SnapshotSchema>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'schema', subBuilder: SnapshotSchema.create)
    ..hasRequiredFields = false
  ;
...
class SnapshotKVItem extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SnapshotKVItem', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'cosmos.base.snapshots.v1beta1'), createEmptyInstance: create)
    ..a<$core.List<$core.int>>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'key', $pb.PbFieldType.OY)
    ..a<$core.List<$core.int>>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'value', $pb.PbFieldType.OY)
    ..hasRequiredFields = false
  ;
  ...
  factory SnapshotKVItem.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory SnapshotKVItem.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SnapshotKVItem copyWith(void Function(SnapshotKVItem) updates) => super.copyWith((message) => updates(message as SnapshotKVItem)) as SnapshotKVItem; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static SnapshotKVItem create() => SnapshotKVItem._();
  SnapshotKVItem createEmptyInstance() => create();
  static $pb.PbList<SnapshotKVItem> createRepeated() => $pb.PbList<SnapshotKVItem>();
  @$core.pragma('dart2js:noInline')
  static SnapshotKVItem getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<SnapshotKVItem>(create);
...
class SnapshotSchema extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SnapshotSchema', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'cosmos.base.snapshots.v1beta1'), createEmptyInstance: create)
  ...
  factory SnapshotSchema.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory SnapshotSchema.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SnapshotSchema copyWith(void Function(SnapshotSchema) updates) => super.copyWith((message) => updates(message as SnapshotSchema)) as SnapshotSchema; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static SnapshotSchema create() => SnapshotSchema._();
  SnapshotSchema createEmptyInstance() => create();
  static $pb.PbList<SnapshotSchema> createRepeated() => $pb.PbList<SnapshotSchema>();
  @$core.pragma('dart2js:noInline')
  static SnapshotSchema getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<SnapshotSchema>(create);
