...
const SnapshotItem$json = const {
  ...
  '2': const [
    ...
    const {'1': 'kv', '3': 5, '4': 1, '5': 11, '6': '.cosmos.base.snapshots.v1beta1.SnapshotKVItem', '8': const {}, '9': 0, '10': 'kv'},
    const {'1': 'schema', '3': 6, '4': 1, '5': 11, '6': '.cosmos.base.snapshots.v1beta1.SnapshotSchema', '9': 0, '10': 'schema'},
  ],
  '8': const [
    const {'1': 'item'},
  ],
...
final $typed_data.Uint8List snapshotItemDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List snapshotKVItemDescriptor = $convert.base64Decode('Cg5TbmFwc2hvdEtWSXRlbRIQCgNrZXkYASABKAxSA2tleRIUCgV2YWx1ZRgCIAEoDFIFdmFsdWU=');
...
final $typed_data.Uint8List snapshotSchemaDescriptor = $convert.base64Decode('Cg5TbmFwc2hvdFNjaGVtYRISCgRrZXlzGAEgAygMUgRrZXlz');
