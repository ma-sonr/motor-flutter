...
class GenesisState extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GenesisState', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'cosmos.bank.v1beta1'), createEmptyInstance: create)
    ...
    ..pc<$11.Coin>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'supply', $pb.PbFieldType.PM, subBuilder: $11.Coin.create)
    ..pc<$12.Metadata>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'denomMetadata', $pb.PbFieldType.PM, subBuilder: $12.Metadata.create)
    ..pc<$12.SendEnabled>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'sendEnabled', $pb.PbFieldType.PM, subBuilder: $12.SendEnabled.create)
  ...
  factory GenesisState({
    ...
    $core.Iterable<$12.Metadata>? denomMetadata,
  ...
  @$pb.TagNumber(3)
  $core.List<$11.Coin> get supply => $_getList(2);

  @$pb.TagNumber(4)
  $core.List<$12.Metadata> get denomMetadata => $_getList(3);

  @$pb.TagNumber(5)
  $core.List<$12.SendEnabled> get sendEnabled => $_getList(4);
}
...
class Balance extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Balance', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'cosmos.bank.v1beta1'), createEmptyInstance: create)
    ...
    ..pc<$11.Coin>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'coins', $pb.PbFieldType.PM, subBuilder: $11.Coin.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $core.List<$11.Coin> get coins => $_getList(1);
}
