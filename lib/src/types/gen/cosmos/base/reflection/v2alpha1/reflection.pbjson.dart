...
const $core.Map<$core.String, $core.dynamic> ReflectionServiceBase$json = const {
  '1': 'ReflectionService',
  '2': const [
    const {'1': 'GetAuthnDescriptor', '2': '.cosmos.base.reflection.v2alpha1.GetAuthnDescriptorRequest', '3': '.cosmos.base.reflection.v2alpha1.GetAuthnDescriptorResponse', '4': const {}},
    const {'1': 'GetChainDescriptor', '2': '.cosmos.base.reflection.v2alpha1.GetChainDescriptorRequest', '3': '.cosmos.base.reflection.v2alpha1.GetChainDescriptorResponse', '4': const {}},
    const {'1': 'GetCodecDescriptor', '2': '.cosmos.base.reflection.v2alpha1.GetCodecDescriptorRequest', '3': '.cosmos.base.reflection.v2alpha1.GetCodecDescriptorResponse', '4': const {}},
    const {'1': 'GetConfigurationDescriptor', '2': '.cosmos.base.reflection.v2alpha1.GetConfigurationDescriptorRequest', '3': '.cosmos.base.reflection.v2alpha1.GetConfigurationDescriptorResponse', '4': const {}},
    const {'1': 'GetQueryServicesDescriptor', '2': '.cosmos.base.reflection.v2alpha1.GetQueryServicesDescriptorRequest', '3': '.cosmos.base.reflection.v2alpha1.GetQueryServicesDescriptorResponse', '4': const {}},
    const {'1': 'GetTxDescriptor', '2': '.cosmos.base.reflection.v2alpha1.GetTxDescriptorRequest', '3': '.cosmos.base.reflection.v2alpha1.GetTxDescriptorResponse', '4': const {}},
  ],
};
...
const $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>> ReflectionServiceBase$messageJson = const {
  '.cosmos.base.reflection.v2alpha1.GetAuthnDescriptorRequest': GetAuthnDescriptorRequest$json,
  '.cosmos.base.reflection.v2alpha1.GetAuthnDescriptorResponse': GetAuthnDescriptorResponse$json,
  '.cosmos.base.reflection.v2alpha1.AuthnDescriptor': AuthnDescriptor$json,
  '.cosmos.base.reflection.v2alpha1.SigningModeDescriptor': SigningModeDescriptor$json,
  '.cosmos.base.reflection.v2alpha1.GetChainDescriptorRequest': GetChainDescriptorRequest$json,
  '.cosmos.base.reflection.v2alpha1.GetChainDescriptorResponse': GetChainDescriptorResponse$json,
  '.cosmos.base.reflection.v2alpha1.ChainDescriptor': ChainDescriptor$json,
  '.cosmos.base.reflection.v2alpha1.GetCodecDescriptorRequest': GetCodecDescriptorRequest$json,
  '.cosmos.base.reflection.v2alpha1.GetCodecDescriptorResponse': GetCodecDescriptorResponse$json,
  '.cosmos.base.reflection.v2alpha1.CodecDescriptor': CodecDescriptor$json,
  '.cosmos.base.reflection.v2alpha1.InterfaceDescriptor': InterfaceDescriptor$json,
  '.cosmos.base.reflection.v2alpha1.InterfaceAcceptingMessageDescriptor': InterfaceAcceptingMessageDescriptor$json,
  '.cosmos.base.reflection.v2alpha1.InterfaceImplementerDescriptor': InterfaceImplementerDescriptor$json,
  '.cosmos.base.reflection.v2alpha1.GetConfigurationDescriptorRequest': GetConfigurationDescriptorRequest$json,
  '.cosmos.base.reflection.v2alpha1.GetConfigurationDescriptorResponse': GetConfigurationDescriptorResponse$json,
  '.cosmos.base.reflection.v2alpha1.ConfigurationDescriptor': ConfigurationDescriptor$json,
  '.cosmos.base.reflection.v2alpha1.GetQueryServicesDescriptorRequest': GetQueryServicesDescriptorRequest$json,
  '.cosmos.base.reflection.v2alpha1.GetQueryServicesDescriptorResponse': GetQueryServicesDescriptorResponse$json,
  '.cosmos.base.reflection.v2alpha1.QueryServicesDescriptor': QueryServicesDescriptor$json,
  '.cosmos.base.reflection.v2alpha1.QueryServiceDescriptor': QueryServiceDescriptor$json,
  '.cosmos.base.reflection.v2alpha1.QueryMethodDescriptor': QueryMethodDescriptor$json,
  '.cosmos.base.reflection.v2alpha1.GetTxDescriptorRequest': GetTxDescriptorRequest$json,
  '.cosmos.base.reflection.v2alpha1.GetTxDescriptorResponse': GetTxDescriptorResponse$json,
  '.cosmos.base.reflection.v2alpha1.TxDescriptor': TxDescriptor$json,
  '.cosmos.base.reflection.v2alpha1.MsgDescriptor': MsgDescriptor$json,
};

/// Descriptor for `ReflectionService`. Decode as a `google.protobuf.ServiceDescriptorProto`.
final $typed_data.Uint8List reflectionServiceDescriptor = $convert.base64Decode('');
