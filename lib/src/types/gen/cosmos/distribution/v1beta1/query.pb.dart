...
class QueryValidatorDistributionInfoRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'QueryValidatorDistributionInfoRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'cosmos.distribution.v1beta1'), createEmptyInstance: create)
  ...
  factory QueryValidatorDistributionInfoRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory QueryValidatorDistributionInfoRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  QueryValidatorDistributionInfoRequest clone() => QueryValidatorDistributionInfoRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  QueryValidatorDistributionInfoRequest copyWith(void Function(QueryValidatorDistributionInfoRequest) updates) => super.copyWith((message) => updates(message as QueryValidatorDistributionInfoRequest)) as QueryValidatorDistributionInfoRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static QueryValidatorDistributionInfoRequest create() => QueryValidatorDistributionInfoRequest._();
  QueryValidatorDistributionInfoRequest createEmptyInstance() => create();
  static $pb.PbList<QueryValidatorDistributionInfoRequest> createRepeated() => $pb.PbList<QueryValidatorDistributionInfoRequest>();
  @$core.pragma('dart2js:noInline')
  static QueryValidatorDistributionInfoRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<QueryValidatorDistributionInfoRequest>(create);
...
class QueryValidatorDistributionInfoResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'QueryValidatorDistributionInfoResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'cosmos.distribution.v1beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'operatorAddress')
    ..pc<$11.DecCoin>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'selfBondRewards', $pb.PbFieldType.PM, subBuilder: $11.DecCoin.create)
    ..pc<$11.DecCoin>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'commission', $pb.PbFieldType.PM, subBuilder: $11.DecCoin.create)
    ..hasRequiredFields = false
  ;
  ...
  factory QueryValidatorDistributionInfoResponse({
    ...
    $core.Iterable<$11.DecCoin>? selfBondRewards,
    $core.Iterable<$11.DecCoin>? commission,
  }) {
    final _result = create();
    ...
    if (selfBondRewards != null) {
      _result.selfBondRewards.addAll(selfBondRewards);
    }
    if (commission != null) {
  ...
  factory QueryValidatorDistributionInfoResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory QueryValidatorDistributionInfoResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  QueryValidatorDistributionInfoResponse clone() => QueryValidatorDistributionInfoResponse()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  QueryValidatorDistributionInfoResponse copyWith(void Function(QueryValidatorDistributionInfoResponse) updates) => super.copyWith((message) => updates(message as QueryValidatorDistributionInfoResponse)) as QueryValidatorDistributionInfoResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static QueryValidatorDistributionInfoResponse create() => QueryValidatorDistributionInfoResponse._();
  QueryValidatorDistributionInfoResponse createEmptyInstance() => create();
  static $pb.PbList<QueryValidatorDistributionInfoResponse> createRepeated() => $pb.PbList<QueryValidatorDistributionInfoResponse>();
  @$core.pragma('dart2js:noInline')
  static QueryValidatorDistributionInfoResponse getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<QueryValidatorDistributionInfoResponse>(create);
  ...
  @$pb.TagNumber(2)
  $core.List<$11.DecCoin> get selfBondRewards => $_getList(1);

  @$pb.TagNumber(3)
  $core.List<$11.DecCoin> get commission => $_getList(2);
}
...
class QueryDelegationRewardsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'QueryDelegationRewardsResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'cosmos.distribution.v1beta1'), createEmptyInstance: create)
    ..pc<$11.DecCoin>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'rewards', $pb.PbFieldType.PM, subBuilder: $11.DecCoin.create)
    ..hasRequiredFields = false
  ;

  QueryDelegationRewardsResponse._() : super();
  factory QueryDelegationRewardsResponse({
    $core.Iterable<$11.DecCoin>? rewards,
  }) {
    final _result = create();
    if (rewards != null) {
  ...
  @$pb.TagNumber(1)
  $core.List<$11.DecCoin> get rewards => $_getList(0);
}
...
class QueryCommunityPoolResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'QueryCommunityPoolResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'cosmos.distribution.v1beta1'), createEmptyInstance: create)
    ..pc<$11.DecCoin>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pool', $pb.PbFieldType.PM, subBuilder: $11.DecCoin.create)
    ..hasRequiredFields = false
  ;

  QueryCommunityPoolResponse._() : super();
  factory QueryCommunityPoolResponse({
    $core.Iterable<$11.DecCoin>? pool,
  }) {
    final _result = create();
    if (pool != null) {
  ...
  @$pb.TagNumber(1)
  $core.List<$11.DecCoin> get pool => $_getList(0);
}
...
class QueryApi {
  ...
  $async.Future<QueryValidatorDistributionInfoResponse> validatorDistributionInfo($pb.ClientContext? ctx, QueryValidatorDistributionInfoRequest request) {
    var emptyResponse = QueryValidatorDistributionInfoResponse();
    return _client.invoke<QueryValidatorDistributionInfoResponse>(ctx, 'Query', 'ValidatorDistributionInfo', request, emptyResponse);
  }
  $async.Future<QueryValidatorOutstandingRewardsResponse> validatorOutstandingRewards($pb.ClientContext? ctx, QueryValidatorOutstandingRewardsRequest request) {
    var emptyResponse = QueryValidatorOutstandingRewardsResponse();
    return _client.invoke<QueryValidatorOutstandingRewardsResponse>(ctx, 'Query', 'ValidatorOutstandingRewards', request, emptyResponse);
  }
  $async.Future<QueryValidatorCommissionResponse> validatorCommission($pb.ClientContext? ctx, QueryValidatorCommissionRequest request) {
    var emptyResponse = QueryValidatorCommissionResponse();
    return _client.invoke<QueryValidatorCommissionResponse>(ctx, 'Query', 'ValidatorCommission', request, emptyResponse);
  }
  $async.Future<QueryValidatorSlashesResponse> validatorSlashes($pb.ClientContext? ctx, QueryValidatorSlashesRequest request) {
    var emptyResponse = QueryValidatorSlashesResponse();
    return _client.invoke<QueryValidatorSlashesResponse>(ctx, 'Query', 'ValidatorSlashes', request, emptyResponse);
  }
  $async.Future<QueryDelegationRewardsResponse> delegationRewards($pb.ClientContext? ctx, QueryDelegationRewardsRequest request) {
    var emptyResponse = QueryDelegationRewardsResponse();
    return _client.invoke<QueryDelegationRewardsResponse>(ctx, 'Query', 'DelegationRewards', request, emptyResponse);
  }
  $async.Future<QueryDelegationTotalRewardsResponse> delegationTotalRewards($pb.ClientContext? ctx, QueryDelegationTotalRewardsRequest request) {
    var emptyResponse = QueryDelegationTotalRewardsResponse();
    return _client.invoke<QueryDelegationTotalRewardsResponse>(ctx, 'Query', 'DelegationTotalRewards', request, emptyResponse);
  }
  $async.Future<QueryDelegatorValidatorsResponse> delegatorValidators($pb.ClientContext? ctx, QueryDelegatorValidatorsRequest request) {
    var emptyResponse = QueryDelegatorValidatorsResponse();
    return _client.invoke<QueryDelegatorValidatorsResponse>(ctx, 'Query', 'DelegatorValidators', request, emptyResponse);
  }
  $async.Future<QueryDelegatorWithdrawAddressResponse> delegatorWithdrawAddress($pb.ClientContext? ctx, QueryDelegatorWithdrawAddressRequest request) {
    var emptyResponse = QueryDelegatorWithdrawAddressResponse();
    return _client.invoke<QueryDelegatorWithdrawAddressResponse>(ctx, 'Query', 'DelegatorWithdrawAddress', request, emptyResponse);
  }
  $async.Future<QueryCommunityPoolResponse> communityPool($pb.ClientContext? ctx, QueryCommunityPoolRequest request) {
    var emptyResponse = QueryCommunityPoolResponse();
    return _client.invoke<QueryCommunityPoolResponse>(ctx, 'Query', 'CommunityPool', request, emptyResponse);
  }
}
