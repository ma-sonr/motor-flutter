...
import '../../schema/v1/schema.pbenum.dart' as $0;
...
class CreateSchemaRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CreateSchemaRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'sonrio.motor.api.v1'), createEmptyInstance: create)
    ...
    ..m<$core.String, $0.SchemaKind>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'fields', entryClassName: 'CreateSchemaRequest.FieldsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OE, valueOf: $0.SchemaKind.valueOf, enumValues: $0.SchemaKind.values, defaultEnumValue: $0.SchemaKind.LIST, packageName: const $pb.PackageName('sonrio.motor.api.v1'))
  ...
  factory CreateSchemaRequest({
    $core.String? label,
    $core.Map<$core.String, $0.SchemaKind>? fields,
    $core.Map<$core.String, $core.String>? metadata,
  }) {
    final _result = create();
    if (label != null) {
  ...
  @$pb.TagNumber(2)
  $core.Map<$core.String, $0.SchemaKind> get fields => $_getMap(1);
