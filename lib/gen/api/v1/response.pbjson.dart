...
const CreateSchemaResponse$json = const {
  ...
  '2': const [
    const {'1': 'what_is', '3': 1, '4': 1, '5': 12, '10': 'whatIs'},
  ],
};

/// Descriptor for `CreateSchemaResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List createSchemaResponseDescriptor = $convert.base64Decode('ChRDcmVhdGVTY2hlbWFSZXNwb25zZRIXCgd3aGF0X2lzGAEgASgMUgZ3aGF0SXM=');
...
final $typed_data.Uint8List queryWhatIsResponseDescriptor = $convert.base64Decode('ChNRdWVyeVdoYXRJc1Jlc3BvbnNlEhcKB3doYXRfaXMYASABKAxSBndoYXRJcw==');
